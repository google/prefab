 ...
 */
interface PackageMetadata : Metadata {
    companion object :
        MetadataLoader<PackageMetadata, PackageMetadataV1, Unit> {
        override fun metadataClassFor(
            schemaVersion: SchemaVersion
        ): PackageMetadataV1.Companion = when (schemaVersion) {
            SchemaVersion.V1 -> PackageMetadataV1
            SchemaVersion.V2 -> PackageMetadataV1
        }
        ...
        ): PackageMetadataV1 = loadAndMigrate(schemaVersion, directory, Unit)
    }
}
